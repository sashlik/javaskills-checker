...
После проведения всех тестов, приложение останавливается, останавливая также тестовые веб-сервис и рест сервис.
...
В тестируемом приложении, в свою очередь, нужно указать URL поднимаемого веб-сервиса и рест сервиса. Например если данное приложение поднимается на localhost и порту 8090, то в тестируемом приложении нужно указать следующие ENV переменные: 
