...
При старте поднимает тестовый SOAP веб-сервис, а также тестовый REST API. В них будет обращаться приложение участника по условию задания.

Checker должен запускаться после того как приложение участника уже запущено и готово к вызовам по API
